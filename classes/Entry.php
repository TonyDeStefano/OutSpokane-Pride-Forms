...
class Entry
{
     ...
     */
    public static function drawDefaultFormFields($exclusions = NULL, $hide_position_field = TRUE, $replacements = [])
    {
        ...
        foreach ($inclusions as $inclusion) {
            if (!in_array(preg_replace('/[^A-Za-z0-9]/', '_', strtolower($inclusion)), $exclusions)) {
                self::drawFormField($inclusion, null, 'text', null, $replacements);
            }
        }
    }
     ...
     * @param array $replacements
     */
    public static function drawFormField($label, $id = NULL, $type = 'text', $options = NULL, $replacements = [])
    {
        ...
        echo '
			<div class="row">
				<div class="col-md-3">
					<label for="' . $id . '">' . ((array_key_exists($label, $replacements)) ? $replacements[$label] : $label) . '</label>
				</div>
				<div class="col-md-6">';
