...
<div class="wrap">
	...
	<?php if ( $action == 'view' ) { ?>
		...
		<?php $entry = new \OutSpokane\Sponsorship( (isset($_GET['id'])) ? $_GET['id'] : 0 ); ?>
		...
		<?php } else { ?>
			...
			<h1>
				...
				<a href="?page=outspokane_edit_entry&form=sponsorship&id=<?php echo $entry->getId(); ?>" class="page-title-action">
					Edit
				</a>
				<a href="#" class="page-title-action" id="pride-delete-entry" data-form="sponsorship" data-id="<?php echo $entry->getId(); ?>">
					Delete
				</a>
			</h1>
			...
			<div class="row">
				<div class="col-md-7">
					...
					<div class="well">
						...
						<table class="table">
							...
							<tr>
								<th>Title:</th>
								<td><?php echo $entry->getEntryYear(); ?> Sponsorship</td>
							</tr>
							...
							<tr>
								...
								<td>
									...
									<?php if ( strlen( $entry->getPosition() ) > 0 ) { ?>
										<em><?php echo $entry->getPosition(); ?></em><br>
									<?php } ?>
							...
							<tr>
								<th>Local Contact:</th>
								<td>
									<?php echo $entry->getLocalName(); ?><br>
									<?php if ( strlen( $entry->getLocalPosition() ) > 0 ) { ?>
										<em><?php echo $entry->getLocalPosition(); ?></em><br>
									<?php } ?>
									<?php echo $entry->getLocalPhone(); ?><br>
									<?php echo $entry->getLocalEmail(); ?>
								</td>
							</tr>
							<tr>
								<th>Local Address:</th>
								<td>
									<?php echo $entry->getLocalAddress(); ?><br>
									<?php echo $entry->getLocalCSZ(); ?>
								</td>
							</tr>
							<tr>
								<th>URL</th>
								<td><a href="<?php echo $entry->getUrl(); ?>" target="_blank"><?php echo $entry->getUrl(); ?></a></td>
							</tr>
							<tr>
								<th>Sponsorship Level</th>
								<td><?php echo $entry->getLevel(); ?></td>
							</tr>
							<tr>
								<th>Sponsorship Amount</th>
								<td>$<?php echo number_format( $entry->getAmount(), 2 ); ?></td>
							</tr>
					...
					{
						if ( preg_match('/\[pride_forms[^\]]*form=["\']sponsorship["\'][^\]]*\]/', $page->post_content) === 1)
						{
				...
				<div class="col-md-5">
					...
					<div class="well" id="pride-forms-update-entry-notes" data-form="sponsorship" data-id="<?php echo $entry->getId(); ?>">
					...
					<div class="well" id="pride-forms-mark-as-paid" data-form="sponsorship" data-id="<?php echo $entry->getId(); ?>">
