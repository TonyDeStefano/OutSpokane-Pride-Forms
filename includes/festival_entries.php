...
<div class="wrap">
	...
	<?php if ( $action == 'view' ) { ?>
		...
		<?php $entry = new \OutSpokane\FestivalEntry( (isset($_GET['id'])) ? $_GET['id'] : 0 ); ?>
		...
		<?php } else { ?>
			...
			<div class="row">
				<div class="col-md-7">
					...
					{
						if ( preg_match('/\[pride_forms[^\]]*form=["\']festival["\'][^\]]*\]/', $page->post_content) === 1)
						{
				...
				<div class="col-md-5">
					...
					<div class="well" id="pride-forms-update-entry-notes" data-form="festival" data-id="<?php echo $entry->getId(); ?>">
					...
					<?php if ($entry->getTotal() > 0) { ?>
						...
						<div class="well" id="pride-forms-mark-as-paid" data-form="festival" data-id="<?php echo $entry->getId(); ?>">
