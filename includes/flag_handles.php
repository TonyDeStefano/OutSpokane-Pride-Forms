...
<div class="wrap">
	...
	<?php if ( $action == 'view' ) { ?>
		...
		<?php $entry = new \OutSpokane\FlagHandle( (isset($_GET['id'])) ? $_GET['id'] : 0 ); ?>
		...
		<?php } else { ?>
			...
			<h1>
				...
				<a href="?page=outspokane_edit_entry&form=flag&id=<?php echo $entry->getId(); ?>" class="page-title-action">
					Edit
				</a>
				<a href="#" class="page-title-action" id="pride-delete-entry" data-form="flag" data-id="<?php echo $entry->getId(); ?>">
					Delete
				</a>
			</h1>
			...
			<div class="row">
				<div class="col-md-7">
					...
					<div class="well" id="pride-forms-update-details" data-form="flag" data-id="<?php echo $entry->getId(); ?>">
					...
					{
						if ( preg_match('/\[pride_forms[^\]]*form=["\']flag["\'][^\]]*\]/', $page->post_content) === 1)
						{
				...
				<div class="col-md-5">
					...
					<div class="well" id="pride-forms-update-entry-notes" data-form="flag" data-id="<?php echo $entry->getId(); ?>">
					...
					<div class="well" id="pride-forms-mark-as-paid" data-form="flag" data-id="<?php echo $entry->getId(); ?>">
